...
describe('Central de Atendimento ao Cliente TAT', function () {
    ...
    it('se um valor não-numérico for digitado, seu valor continuará vazio no campo telefone.', function () {
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function () {
        ...
        cy.get('#lastName')
            ...
            .clear().should('have.value', '')
        cy.get('#email')
            .type('rairblack@gmail.com')
            .should('have.value', 'rairblack@gmail.com')
            .clear().should('have.value', '')
        cy.get('#phone')
            .type('11999999999')
